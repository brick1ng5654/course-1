...
void output_director(DHD *dph, int n, int k); /* Output list with DIR structure (n for PRINT HEAD), k for BACKWARD or FORWARD directon */
...
void output_and_delete(DHD *dph, MHD *mph, int n); /* Output director list and delete the last output one from the end */
